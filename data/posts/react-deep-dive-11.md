...
<span style='color: lightblue'>Reconciler</span> → Scheduler → host-config(in Scheduler) → Render Phase(in Reconciler) → Commit(in Reconciler) 
...
1. <span style='background-color: #FFB6C1'>Reconcile trigger dispatchAction</span>
   ...
   <span style='background-color: #FFB6C1'>1) trigger dispatchAction<span style='background-color: #FFB6C1'>
    ...
    <span>2) Reconciler Request Scheduling Work</span>
